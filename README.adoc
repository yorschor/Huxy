...
[CAUTION]
Version 2.0.0 contains rewrite of the API.
...
var result = Result.Nope("An error occurred", new List<Error>
{
    new("ERR001", "Error 1 details"),
    new("ERR002", "Error 2 details")
});
var result = Result.Nope(new Exception("An error occurred"));
----
...
{   
    return Result.Nope("Nope Reason", e);
    var error = new Nope("Nope details");
}
----
